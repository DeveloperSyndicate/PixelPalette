...
import com.devsync.pixelpalettejvm.adobeRGB.gammaCorrectAdobeRGB
import com.devsync.pixelpalettejvm.cielch.labToLch
import com.devsync.pixelpalettejvm.model.CIELCH
import com.devsync.pixelpalettejvm.model.CIELUV
import com.devsync.pixelpalettejvm.model.CMYK
import com.devsync.pixelpalettejvm.model.HSB
import com.devsync.pixelpalettejvm.model.HSL
import com.devsync.pixelpalettejvm.model.HWB
...
import com.devsync.pixelpalettejvm.model.Pantone
import com.devsync.pixelpalettejvm.model.RAL
import com.devsync.pixelpalettejvm.model.Rec2020
import com.devsync.pixelpalettejvm.model.SRGB
import com.devsync.pixelpalettejvm.model.XYZ
import com.devsync.pixelpalettejvm.munsell.labToMunsell
import com.devsync.pixelpalettejvm.sRGB.linearRgbToSrgb
import com.devsync.pixelpalettejvm.sRGB.rgbToLinearRgb
import com.devsync.pixelpalettejvm.utils.labDistance
import com.devsync.pixelpalettejvm.utils.rgbToLab
import com.devsync.pixelpalettejvm.utils.xyzToLab
...
object PixelConversionRGB {
    ...
    fun RGBtoXYZ(red: Int, green: Int, blue: Int, scale: Int = 100): XYZ {
        ...
        val rLinear = if (rNorm > 0.04045) Math.pow((rNorm + 0.055) / 1.055, 2.4) else rNorm / 12.92
        val gLinear = if (gNorm > 0.04045) Math.pow((gNorm + 0.055) / 1.055, 2.4) else gNorm / 12.92
        val bLinear = if (bNorm > 0.04045) Math.pow((bNorm + 0.055) / 1.055, 2.4) else bNorm / 12.92
    ...
    fun RGBToPantone(red: Int, green: Int, blue: Int, pantones: List<Pantone>): Pantone? {
        ...
        return pantones.minByOrNull { pantoneColor ->
    ...
    fun RGBtoCIELCH(r: Int, g: Int, b: Int): CIELCH {
        val lab = com.devsync.pixelpalettejvm.cielch.rgbToLab(r, g, b)
        return labToLch(lab)
    }
