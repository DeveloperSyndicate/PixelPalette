package com.devsync.pixelpaletteandroid.cielch

import com.devsync.pixelpaletteandroid.model.CIELAB
import com.devsync.pixelpaletteandroid.model.CIELCH
import kotlin.math.atan2
import kotlin.math.pow
import kotlin.math.sqrt

internal fun rgbToLab(r: Int, g: Int, b: Int): CIELAB {
    val rNorm = r / 255.0
    val gNorm = g / 255.0
    val bNorm = b / 255.0
...
internal fun labToLch(lab: CIELAB): CIELCH {
